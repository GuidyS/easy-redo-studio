...
const categories: Category[] = [
  {
    ...
    items: [
      { name: "Ibuprofen", detail: "ยาระงับปวด ลดไข้ และลดการอักเสบระดับเริ่มต้น ใช้แก้ปวดหัว ปวดฟัน ปวดประจำเดือน", pros: "ออกฤทธิ์ไว หาซื้อง่าย มีความปลอดภัยค่อนข้างสูงหากใช้ในระยะสั้น มีรูปแบบยาน้ำสำหรับเด็ก", warning: "ยับยั้งทั้ง COX-1 และ COX-2 จึงระคายเคืองกระเพาะอาหาร ต้องทานหลังอาหารทันที ทานตอนท้องว่างไม่ได้", image: drugIbuprofen },
      { name: "Naproxen", detail: "ใช้ลดการอักเสบของกล้ามเนื้อ เส้นเอ็น ปวดข้อ โรคเก๊าท์ และปวดไมเกรน", pros: "ออกฤทธิ์ได้ยาวนาน (ทานแค่วันละ 2 ครั้ง) และมีความปลอดภัยต่อระบบหลอดเลือดและหัวใจมากที่สุดในกลุ่ม NSAIDs", warning: "ระคายเคืองกระเพาะอาหารค่อนข้างสูง และอาจทำให้เกิดแผลในทางเดินอาหารได้หากใช้ต่อเนื่อง", image: drugNaproxen },
      { name: "Diclofenac", detail: "ใช้บรรเทาอาการปวดอักเสบระดับปานกลางถึงรุนแรง เช่น ปวดข้อเข่าเสื่อม ปวดหลัง อาการอักเสบเฉียบพลัน", pros: "เป็นยาที่กดอาการอักเสบได้ดีและแรง มีรูปแบบยาที่หลากหลาย (ยาทา ยาฉีด ยาเม็ด ยาเหน็บ)", warning: "หากใช้ในขนาดยาที่สูงและต่อเนื่องเป็นเวลานาน จะเพิ่มความเสี่ยงต่อโรคหลอดเลือดหัวใจและตับอักเสบ", image: drugDiclofenac },
      { name: "Indomethacin", detail: "ยาแก้อักเสบที่มีความแรงสูง มักใช้ในโรคข้ออักเสบรุนแรง และโรคเก๊าท์กำเริบเฉียบพลัน", pros: "มีประสิทธิภาพสูงและออกฤทธิ์เร็วมากในการหยุดกระบวนการอักเสบที่รุนแรง", warning: "ผลข้างเคียงเยอะ กัดกระเพาะรุนแรง และมักทำให้เกิดผลข้างเคียงทางระบบประสาท เช่น ปวดศีรษะรุนแรง เวียนศีรษะ มึนงง", image: drugIndomethacin },
      { name: "Mefenamic acid", detail: "บรรเทาอาการปวดประจำเดือน รวมถึงใช้ลดอาการปวดระดับเล็กน้อยถึงปานกลาง เช่น ปวดฟัน ปวดกล้ามเนื้อ", pros: "ดูดซึมเร็ว ออกฤทธิ์ไว และมีความเฉพาะเจาะจงในการระงับอาการปวดเกร็งของกล้ามเนื้อมดลูกช่วงมีประจำเดือนได้ดีมาก", warning: "ไม่ควรรับประทานติดต่อกันเกิน 7 วัน เพราะจะเพิ่มความเสี่ยงต่อการเกิดแผลในกระเพาะและเป็นพิษต่อไต ต้องรับประทานหลังอาหารทันที ห้ามทานตอนท้องว่าง", image: drugMefenamic },
      { name: "Aspirin", detail: "เป็นยาต้านเกล็ดเลือดเพื่อป้องกันโรคหลอดเลือดหัวใจและสมองอุดตัน ส่วนขนาดสูงสำหรับแก้ปวดลดไข้ไม่ค่อยนิยมใช้แล้ว", pros: "เป็นยาตัวเดียวในกลุ่มที่มีฤทธิ์ปกป้องหลอดเลือดหัวใจได้อย่างชัดเจน (ในขนาดต่ำ)", warning: "กัดกระเพาะรุนแรง ทำให้เลือดออกหยุดยาก ห้ามใช้เด็ดขาดในเด็กที่มีไข้จากการติดเชื้อไวรัส เพราะอาจทำให้เกิด Reye's syndrome", image: drugAspirin },
      { name: "Meloxicam", detail: "ยาแก้ปวดอักเสบที่ออกฤทธิ์ค่อนไปทางยับยั้ง COX-2 มากกว่า นิยมใช้ในโรคข้อเสื่อมและข้ออักเสบรูมาตอยด์", pros: "ทานเพียงวันละ 1 ครั้ง และระคายเคืองกระเพาะอาหารน้อยกว่ากลุ่มดั้งเดิม", warning: "ออกฤทธิ์ค่อนข้างช้า ไม่เหมาะกับการใช้แก้ปวดแบบฉับพลันทันทีทันใด", image: drugMeloxicam },
      { name: "Piroxicam", detail: "ยาแก้อักเสบกลุ่มเก่าที่ใช้รักษาโรคข้ออักเสบเรื้อรัง", pros: "ตัวยาอยู่ในร่างกายได้นานมาก ทานเพียงวันละ 1 ครั้ง", warning: "มีความเสี่ยงสูงที่จะทำให้เกิดแผลและเลือดออกในทางเดินอาหาร รวมถึงความเสี่ยงในการแพ้ยารุนแรงทางผิวหนัง", image: drugPiroxicam },
      { name: "Celecoxib", detail: "ยากลุ่ม Selective COX-2 Inhibitor ใช้แก้ปวดข้อ ปวดหลัง หรือปวดหลังผ่าตัด", pros: "ระคายเคืองกระเพาะอาหารน้อยมาก ไม่มีผลต่อการเกาะกลุ่มของเกล็ดเลือด ปลอดภัยในคนที่มีความเสี่ยงเลือดออกง่าย", warning: "ห้ามใช้ในผู้ที่มีประวัติแพ้ยากลุ่มซัลฟา (Sulfa allergy) และอาจเพิ่มความเสี่ยงทางหลอดเลือดหัวใจหากใช้ผิดวิธี", image: drugCelecoxib },
      { name: "Etoricoxib", detail: "ยา Selective COX-2 Inhibitor ที่มีความแรงสูง ใช้รักษาเก๊าท์เฉียบพลัน ปวดฟันรุนแรง หรือข้ออักเสบ", pros: "ออกฤทธิ์ได้เร็วและแรงมาก ทานวันละ 1 ครั้ง และปลอดภัยต่อกระเพาะอาหาร", warning: "ห้ามใช้ในผู้ที่มีความดันโลหิตสูงที่ควบคุมไม่ได้ หรือผู้ที่เป็นโรคหัวใจขาดเลือด เพราะยาทำให้ความดันขึ้นและเสี่ยงต่อโรคหัวใจ", image: drugEtoricoxib },
    ],
  },
  {
                                ...
                                {isItemExpanded && (
                                  ...
                                  >
                                    <div className="px-3 pb-3 space-y-2">
                                      ...
                                      {item.pros && (
                                        <div className="flex items-start gap-1.5 bg-primary/10 rounded-lg p-2">
                                          <span className="text-xs font-bold text-primary shrink-0">ข้อดี:</span>
                                          <span className="text-xs text-foreground">{item.pros}</span>
                                        </div>
                                      )}
                                      {item.warning && (
