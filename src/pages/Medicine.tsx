...
const categories: Category[] = [
  {
    ...
    items: [
      { name: "Ibuprofen", detail: "ยาระงับปวด ลดไข้ และลดการอักเสบระดับเริ่มต้น ใช้แก้ปวดหัว ปวดฟัน ปวดประจำเดือน", image: drugIbuprofen },
      { name: "Naproxen", detail: "ใช้ลดการอักเสบของกล้ามเนื้อ เส้นเอ็น ปวดข้อ โรคเก๊าท์ และปวดไมเกรน", image: drugNaproxen },
      { name: "Diclofenac", detail: "ใช้บรรเทาอาการปวดอักเสบระดับปานกลางถึงรุนแรง เช่น ปวดข้อเข่าเสื่อม ปวดหลัง อาการอักเสบเฉียบพลัน", image: drugDiclofenac },
      { name: "Indomethacin", detail: "ยาแก้อักเสบที่มีความแรงสูง มักใช้ในโรคข้ออักเสบรุนแรง และโรคเก๊าท์กำเริบเฉียบพลัน", image: drugIndomethacin },
      { name: "Mefenamic acid", detail: "บรรเทาอาการปวดประจำเดือน รวมถึงใช้ลดอาการปวดระดับเล็กน้อยถึงปานกลาง เช่น ปวดฟัน ปวดกล้ามเนื้อ", image: drugMefenamic },
      { name: "Aspirin", detail: "เป็นยาต้านเกล็ดเลือดเพื่อป้องกันโรคหลอดเลือดหัวใจและสมองอุดตัน ส่วนขนาดสูงสำหรับแก้ปวดลดไข้ไม่ค่อยนิยมใช้แล้ว", image: drugAspirin },
      { name: "Meloxicam", detail: "ยาแก้ปวดอักเสบที่ออกฤทธิ์ค่อนไปทางยับยั้ง COX-2 มากกว่า นิยมใช้ในโรคข้อเสื่อมและข้ออักเสบรูมาตอยด์", image: drugMeloxicam },
      { name: "Piroxicam", detail: "ยาแก้อักเสบกลุ่มเก่าที่ใช้รักษาโรคข้ออักเสบเรื้อรัง", image: drugPiroxicam },
      { name: "Celecoxib", detail: "ยากลุ่ม Selective COX-2 Inhibitor ใช้แก้ปวดข้อ ปวดหลัง หรือปวดหลังผ่าตัด", image: drugCelecoxib },
      { name: "Etoricoxib", detail: "ยา Selective COX-2 Inhibitor ที่มีความแรงสูง ใช้รักษาเก๊าท์เฉียบพลัน ปวดฟันรุนแรง หรือข้ออักเสบ", image: drugEtoricoxib },
    ],
  },
  {
